...
#删除冲突核心 packages 
rm -rf $(find ../feeds/packages/ -type d -regex ".*\(alist\|mosdns\|chinadns-ng\|sing-box\|xray-core\|v2ray-core\|v2ray-geodata\|aliyundrive-webdav\).*")
...
UPDATE_PACKAGE "https://github.com/VIKINGYFY/luci-app-advancedplus.git" "main"
